...
?>
	...
	<h3 class="text">Διαδικασία επαλήθευσης λογαριασμού</h3>
	<body>
	<p class="text">Εισάγετε το email που έχετε καταχωρημένο στο λογαριασμό σας ώστε να σας στείλουμε τα στοιχεία εισόδου<p>
<div id="login">
	<form action="validate_forgot.php" method = "post">
		<label for="email">Διεύθυνση email :</label> <input type="text" id="email" name="email"><br /><br />
		<button class="button" type = "submit2">Αποστολή email</button>
	</form>
</div>

</br>

	<a class="button" href="login_home.php">Πίσω </a>
