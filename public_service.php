...
<!-- InstanceBeginEditable name="body" --> 
 ...
 <!--    <div id="login">
	<form action="validate_login_home.php" method = "post">
		<label for="username">Όνομα χρήστη :</label> <input type="username" id="username" name="username" placeholder="username"><br /><br />
		<label style= "margin-right: 30px; " for="password">Κωδικός :</label> <input  id="password" name="password" placeholder="**********" needs autocomplete="off" type="password"><br /><br />
 ...
 <?php
 //session_start();
 if (isset($_SESSION['logged_in_service'])) { 
  unset($_SESSION['logged_in_service']);  
...
?>
    ...
    <form  id="form1" role="form"  action="validate_login.php" method = "post">
        ...
        <div class="row" style="padding-left:370px;">
            <div class="form-group col-lg-3 ">
                <label for="code"  style="padding-right:100px;">Password</label>
                <input id="password" name="password" type="password" class="form-control input-normal" />
            </div>
        </div>
  <!--         <div class="row">
            <div class="form-group col-lg-1">
                <label for="code">Όνομα Χρήστη</label>
                <textarea type="text"   id="username" name="username"class="form-control"  rows="10" cols="40" ></textarea>
            </div>
        </div>
   ...
   -->
        ...
        <button class="button" type = "submit" style="width:100px;" onclick="return SubmitIfValid();">Είσοδος</button>
    </form>
    </br>  </br>  
</div>
...
<br /><br /> 
	<a class="links" href="application_form.php">Δεν έχεις εγγραφεί ακομή ? </a> 
<br /> <br /> <br /> 
 
    <a class="links" href="forgot_service.php">Χάσατε το συνθηματικό σας ?</a> 
