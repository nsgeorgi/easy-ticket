...
<!-- InstanceBegin template="/Templates/dw.dwt.php" codeOutsideHTMLIsLocked="false" -->
 <head>
 ...
 <body>
<div id="container">
<div align="center"> <a href="index.php"> <img src="logo_1163129_web.jpg" alt="asd" width="140" height="68" align="left" /> </a>
   <h2 id="title_"><em><strong><em><strong></strong></em>ΚΑΛΩΣΗΡΘΑΤΕ ΣΤΗΝ EASY TICKET ! </strong></em></h2>
 </div>
<div id="languages" align="right"> <a href="index.php?lang=en"><img src="images/en.png" /></a> <a href="index.php?lang=de"><img src="images/de.png" /></a> <a href="index.php?lang=es"><img src="images/greece.png" /></a> </div>
<nav align="center">
   <div id="navigation">
    <ul>
       <li> </li>
...
<div class="dwuserEasyRotator" style="width: 1000px; height: 417px; position:relative; text-align: left;" data-erconfig="{autoplayEnabled:false, lpp:'102-105-108-101-58-47-47-47-67-58-47-85-115-101-114-115-47-78-105-99-107-47-68-111-99-117-109-101-110-116-115-47-69-97-115-121-82-111-116-97-116-111-114-80-114-101-118-105-101-119-47-112-114-101-118-105-101-119-95-115-119-102-115-47', wv:1}" data-ername="eeee" data-ertid="{awl2764tt9713363865141}">
  <div data-ertype="content" style="display: none;">
    <ul data-erlabel="Main Category">
      <li> <img class="main" src="thief.jpg" alt="Waiting to be served? Not anymore!" /> <img class="thumb" src="ViewfromGeneralife2.jpg" /> <span class="title">Waiting to be served? Not anymore!</span> <span class="desc">Manage your customer flow and improve the service your customers receive before they ever arrive to your location.</span> </li>
      <li> <img class="main" src="slide1.jpg" alt="Waiting to be served? Not anymore!" /> <img class="thumb" src="slide1.jpg" /> <span class="title">Waiting to be served? Not anymore!</span> <span class="desc">Manage your customer flow and improve the service your customers receive before they ever arrive to your location.</span> </li>
      <li> <img class="main" src="Aug-25_13.jpg" alt="Waiting to be served? Not anymore!" /> <img class="thumb" src="Aug-25_13.jpg" /> <span class="title">Waiting to be served? Not anymore!</span> <span class="desc">Manage your customer flow and improve the service your customers receive before they ever arrive to your location.</span> </li>
    </ul>
  </div>
 ...
 function lol($data){ 
  ...
  $_SESSION['username_']   = $_GET['username'];
...
$con = mysqli_connect(HOST, USER, PASS, DB) or die(mysqli_connect_error());
 ...
 <div  align="right"  ><a id="logout"  href="logout.php">Log Out <?php echo $username; ?></a></div>
 <div id="table01" align="center"; >
 <table   >
 <tr>
   <th>AMKA</th>
   <th>Number</th>
...
<div id="footer"> <img src="images/copy.png"  alt="asd" width="20" height="10"  /> Copyright &copy; - 2014 Site designed and created by Easy Ticket - All rights reserved</div>
</div>
</div>
</body>
<!-- InstanceEnd -->
