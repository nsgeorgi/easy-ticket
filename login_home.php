...
?>
 ...
 -->
   ...
   <form  id="form1" role="form"  action="validate_login_home.php" method = "post">
...
<br /><br /> 
	<a class="links" href="registration.php">Δεν έχεις εγγραφεί ακόμη;</a><br /><br /> 
		<a class="links" href="forgot.php">Ξέχασες τον κωδικό;</a><br /><br />
