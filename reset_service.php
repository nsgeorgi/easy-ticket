...
{          
	...
	$encrypt=$_GET['encrypt'];
		$query = mysql_query("SELECT *  FROM login WHERE  password= '$encrypt'");
...
<div id="login">
	<form action="validate_reset_service.php?username=nick" method = "post">
	<table>
	<tr>
	<td>Συνθηματικό: </td>
	<td><input type="password" name="pass" size="20" maxlength="20" value="" /> 
	<small>Επιτρέπονται μόνο γράμματα, αριθμοί και η κάτω παύλα (4-20 χαρακτήρες).</small></td>
	</tr>
	
	<tr>
	<td>Επιβεβαίωση Συνθηματικού: </td> 
	<td><input type="password" name="conf_pass" size="20" maxlength="20" value="" /></td>
	</tr>
	
	<tr>
	<td></td>
	<td><input type="submit" name="submit" class="button"  value="Εγγραφή" /></td>
	</tr>
		</table>
	</form>
</div>
			 ...
			 ';
				...
				echo 'Υπήρξε σφάλμα , παρακαλώ προσπαθήστε ξανά .  </br> </br> </br> 	<a class="links" href="forgot.php">Ξέχασες τον κωδικό;</a><br /><br />' ;
...
<div id="login">
	<form action="validate_reset.php?username=nick" method = "post">
	<table>
	<tr>
	<td>Συνθηματικό: </td>
	<td><input type="password" name="pass" size="20" maxlength="20" value="" /> 
