...
<input  style="margin-right:2px" id="name" name="username" placeholder="username"  value="<?php echo $username; ?>" type="text"> <br /><br /><br />
<label>Συνθηματικό :</label>
<input style="margin-left:10px " id="password" name="password" placeholder="**********"   value="<?php echo $password; ?>"type="password">
<input  style="margin-top:20px " name="submit" type="submit" value=" Σύνδεση " class="button">
