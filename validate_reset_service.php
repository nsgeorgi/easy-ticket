...
header('HTTP/1.1 303 See Other');
	...
	if ($error=='') { // Αν δεν υπάρχουν σφάλματα
		...
		$q = "Update login set password=MD5('$p')  where username='$username' "; // χρήση της συνάρτησης MD5 για το συνθηματικό
   ...
   $next_page = 'reset_service.php';    // public service einai !!
