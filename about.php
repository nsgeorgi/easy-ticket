...
<img src="images/info.png" alt="asd" width="100" height="40" align="left" />  

 <h2 id="about_title" align="left"><em><strong>Σχετικά </strong></em> </h2>
</div>

<p class="text" align="justify">  To  " Easy Ticket " είναι ένα πρόγραμμα, το οποίο έχει ως σκοπό να αποφορτίζει τις ουρές αναμονής σε διάφορες υπηρεσίες, όπως η Εφορία ή ένα νοσοκομείο. Παρέχει στον ενδιαφερόμενο χρήστη, τη δυνατότητα να λαμβάνει σειρά στην ουρά είτε από κάποιο μηχάνημα της υπηρεσίας, είτε ηλεκτρονικά, από τον προσωπικό υπολογιστή του μέσω Internet, χωρίς να βρίσκεται απαραίτητα στο χώρο της υπηρεσίας. Ενημερώνει το χρήστη για την κατάσταση της ουράς κάθε χρονική στιγμή και προσφέρει μία εκτίμηση του χρόνου που θα χρειαστεί να περιμένει μέχρι να εξυπηρετηθεί.  <br />
Επικοινωνήστε ελεύθερα μαζί μας  με οποιεσδήποτε ερωτήσεις όσον αφορά το πως μπορεί να βελτιωθεί  η υπηρεσίας σας και να μειώσετε ακόμα περισσότερο το χρόνο αναμονής των πελατών σας . </br> 
<a  style="color:#FFF" href="contact.php"> Επικοινωνήστε </a> και θα χαρούμε να σας εξυπηρετήσουμε !</p>
 <!-- InstanceEndEditable -->
