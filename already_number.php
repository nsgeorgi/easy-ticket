...
?>
    ...
    <form name="cust_det" id="cust_det" method="POST" action="validate_already_num.php">
    
      <input type="hidden" name="hash" id="hash" value="<?php echo microtime(); ?>" />
     <br />
    <em><strong>   Παρακαλούμε πληκτρολογήστε το ΑΜΚΑ σας : <br /> </strong></em> <br />
    <em><strong>      AΜΚΑ : </strong></em><input type="text" name="amka" id="amka"  value="<?php echo $amka; ?>" maxlength="11"/> <br /> <br /><br /> <br />
