...
<?php  $amka=$_GET['amka']; ?>
    <form name="cust_det" id="cust_det" method="POST" action="validate_sec_attempt.php?amka=<?php echo $amka ?>">
    ...
    <em><strong> <?php if ($_GET['attempt']==1) { echo ' Η σειρά σας έχει περάσει.Εάν θέλετε να ξαναπάρετε θέση στην ουρά πατήστε "Συνέχεια" : '; }else
     ...
     <?php if ($_GET['attempt']==1) { $amka=$_GET['amka'];  $query_string = '?amka=' . $amka;
