...
<div class="dwuserEasyRotator" style="width: 1000px; height: 417px; position:relative; text-align: left;" data-erconfig="{autoplayEnabled:true, lpp:'102-105-108-101-58-47-47-47-67-58-47-85-115-101-114-115-47-78-105-99-107-47-68-111-99-117-109-101-110-116-115-47-69-97-115-121-82-111-116-97-116-111-114-80-114-101-118-105-101-119-47-112-114-101-118-105-101-119-95-115-119-102-115-47', wv:1}" data-ername="eeee" data-ertid="{awl2764tt9713363865141}">
  <div data-ertype="content" style="display: none;"><ul data-erlabel="Main Category">
	<li>
		<img class="main" src="thief.jpg" alt="Waiting to be served? Not anymore!" /> <img class="thumb" src="ViewfromGeneralife2.jpg" />
	...
	<li>
		<img class="main" src="slide1.jpg" alt="Waiting to be served? Not anymore!" /> <img class="thumb" src="slide1.jpg" /> 
		<span class="title">Waiting to be served? Not anymore!</span>
		<span class="desc">Manage your customer flow and improve the service your customers receive before they ever arrive to your location.</span>
	</li>
	<li>
...
if ( $flag=='1' && $_SESSION['temp']=='1') {
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    ...
    <script type="text/javascript">
        bootbox.alert("Οι ρυθμίσεις μόλις ανανεώθηκαν ! ")
...
/* echo '<script type="text/javascript">alert(">Η εγγραφή σας στο σύστημα ολοκληρώθηκε επιτυχώς.Μέσα στο επόμενο 24ώρο εφόσον τα στοιχεία σας επιβεβαιωθούν ότι είναι έγκυρα , θα σας σταλθεί ένα εμαίλ με τον κωδικό σας , στο ηλεκτρονικό σας ταχυδρομείο.");</script>'; */
/*	echo '<h1 class= "text">Ευχαριστούμε!</h1>
		<p class= "text">Η εγγραφή σας στο σύστημα ολοκληρώθηκε επιτυχώς.Μέσα στο επόμενο 24ώρο εφόσον τα στοιχεία σας επιβεβαιωθούν ότι είναι έγκυρα , θα σας σταλθεί ένα εμαίλ με τον κωδικό σας , στο ηλεκτρονικό σας ταχυδρομείο. </p><p><br /></p>';	
	*/	
...
//$_SESSION['temp']='0';
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
  ...
  $('#button1').click(function(){
     <?php
	 if   (   isset ($_GET['flag']) )   { 
	 echo'window.location = "queue.php" '; 
 ...
 <button  id="button1"  class="button" style="margin-top:30px; margin-right:50px; text-decoration:none;">Προβολή ουράς</button>

<button id="button2" class="button" style="margin-top:30px; margin-right:50px; text-decoration:none;">Ρυθμίσεις</button>

    <br/> <br/> <br/> <br/> <br/>
      <div id="sample1"  style=" margin-top:50px; padding: .5em; background-color:	#000; border: none;">
      
<form id="login" action="validate_service_options.php" method = "post">
        ...
        <br/> <br/> <br/>
         <label> Αριθμός ατόμων για εξυπηρέτηση</label><br/> <br/>
            <select  name="people"  >
                <option>50</option>
                <option>100</option>
                <option>150</option>
            ...
            <button name="submit" class="button"  type = "submit">Aποθήκευση</button>
          </form>
